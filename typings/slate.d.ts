declare module 'slate' {
    ...
    export class Text extends Immutable.Record({}) {
        ...
        getActiveMarksBetweenOffset(startOffset: number, endOffset: number): Immutable.Set<Mark>;
    ...
    export class Editor implements Controller {
        ...
        isVoid: Controller['isVoid'];
        isAtomic: Controller['isAtomic'];
        command<T>(nameOrFunction: string | ((editor: any, ...args: T) => any), ...args: T): Editor;
