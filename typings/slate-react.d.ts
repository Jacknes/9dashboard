declare module 'slate-react' {
    ...
    export type EventHook<T = React.SyntheticEvent> = (event: T, editor: Editor, next: Next) => any;

    export interface Plugin {
        decorateNode?: (node: Node, editor: Editor, next: Next) => any;
        renderEditor?: (props: EditorProps, editor: Editor, next: Next) => any;
        renderMark?: (props: RenderMarkProps, editor: Editor, next: Next) => any;
        renderNode?: (props: RenderNodeProps, editor: Editor, next: Next) => any;
        renderPlaceholder?: (props: RenderPlaceholderProps, editor: Editor, next: Next) => any;
        normalizeNode?: (node: Node, editor: Editor, next: Next) => any;
        ...
        onBeforeInput?: EventHook<React.SyntheticEvent>;
    ...
    export class Editor extends React.Component<EditorProps, EditorState> implements Controller {
        ...
        isVoid: CoreEditor['isVoid'];
        isAtomic: CoreEditor['isAtomic'];
    ...
    export function findNode(element: Element, editor: Editor): Node;
    export function findRange(selection: Selection, editor: Editor): Range;
    export function getEventRange(event: Event | React.SyntheticEvent, editor: Editor): Range;
